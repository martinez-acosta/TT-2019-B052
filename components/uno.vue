<template>
  <body onload="init()">
    <div id="sample">
      ...
      <p>
        This sample demonstrates the ability for the user to drag around a Link
        as if it were a Node. When either end of the link passes over a valid
        port, the port is highlighted.
      </p>
      <p>
        The link-dragging functionality is enabled by setting some or all of the
      ...
      <p>
        Note that a Link is present in the <a>Palette</a> so that it too can be
        dragged out and onto the main Diagram. Because links are not
        automatically routed when either end is not connected with a Node, the
        route is provided explicitly when that Palette item is defined.
      </p>
      <p>
      ...
      <p>
        ...
        <a>Model.modelData</a> object that is automatically saved and restored
        when calling <a>Model.toJson</a> and <a>Model,fromJson</a>.
      </p>
      <div>
        <div>
